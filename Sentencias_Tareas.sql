...
select uuid_generate_v1() as hola;

CREATE TABLE usuarios (
    id_usuarios uuid default uuid_generate_V4(),
...
CREATE TABLE tareas (
    ...
    id_usuarios uuid REFERENCES usuarios(id_usuarios) ON DELETE cascade,
...
CREATE TABLE historial (
    ...
    fecha_completado TIMESTAMP NULL DEFAULT now(),
    observaciones VARCHAR(100),
    id_tareas int REFERENCES tareas(id_tareas) ON DELETE cascade,
...
call crear_usuario('John Vera','Prueba@uteq.edu.ec','45345fgsdfgf44');
...
select auth_data('jveram10@uteq.edu.ec');
...
call sp_crear_grupos('Proyecto Cuestionarios','Proyecto Cuestionarios para la UTEQ','58040a90-9fa3-4f2e-9ad9-7289d9e66a26');

call sp_crear_grupos('Proyecto Tareas2','Proyecto Tareas para la distribuidas','58040a90-9fa3-4f2e-9ad9-7289d9e66a26');

call sp_crear_grupos('Proyecto Tareas3','Proyecto Tareas para la distribuidas','58040a90-9fa3-4f2e-9ad9-7289d9e66a26');
...
begin
	...
	from grupos g
	where cast(g.id_usuarios as varchar(800)) = p_idu;
end;
$function$
;
...
select fu_grupos_usuario('58040a90-9fa3-4f2e-9ad9-7289d9e66a26')
...
call sp_crear_tareas('Hacer un crud ','Proyecto Tareas para login',false,'58040a90-9fa3-4f2e-9ad9-7289d9e66a26',15);
...
begin
	...
	from tareas t
	where cast(t.id_usuarios as varchar(800)) = p_idu
...
select * from fu_tareas_usuario('58040a90-9fa3-4f2e-9ad9-7289d9e66a26',15);


----------------------------- Procedimiento para crear modicar tarea--------------
...
call sp_modificar_tarea('siiiii','siiiii',false,5);
...
--delete from tareas where id_tareas = 11;
